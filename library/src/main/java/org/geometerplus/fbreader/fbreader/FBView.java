...
public final class FBView extends ZLTextView {
	...
	public ZLTextStyleCollection getTextStyleCollection() {
		return myReader.mWidget.myTextStyleCollection;
	}
	...
	public Integer getTextColor(ZLTextHyperlink hyperlink) {
		...
		switch (hyperlink.Type) {
			...
			case FBHyperlinkType.FOOTNOTE:
				return myReader.mWidget.getCurrentBook().isHyperlinkVisited(hyperlink.Id)
	...
	private class FooterNewStyle extends Footer {
		public synchronized void paint(ZLPaintContext context) {
			...
			final BookModel model = myReader.mWidget.Model;
			if (model == null) {
				return;
			}
	...
	public synchronized void onScrollingFinished(PageIndex pageIndex) {
		...
		myReader.mWidget.storePosition();
	}
